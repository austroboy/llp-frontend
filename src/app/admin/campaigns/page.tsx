...
const CampaignsTab = dynamic(
  () =>
    import("@/app/admin/email/campaigns-tab").then((m) => ({
      default: m.CampaignsTab,
    })),
  { loading: TabFallback }
);
  ...
  return (
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        >
          Campaign <em style={{ fontStyle: "italic", color: "var(--accent-blue)" }}>dispatch.</em>
        </motion.h1>
        <motion.p
          variants={fadeUp}
          ...
          style={{ maxWidth: "60ch" }}
        >
          Compose, schedule, and dispatch broadcasts to subscriber segments. Track opens, clicks, and bounces from the analytics tab.
        </motion.p>
        <motion.div
          variants={fadeUp}
          style={{
